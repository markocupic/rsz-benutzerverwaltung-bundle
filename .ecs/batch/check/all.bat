...
:: legacy
vendor\bin\ecs check vendor/markocupic/rsz-benutzerverwaltung-bundle/src/Resources/contao --config vendor/markocupic/rsz-benutzerverwaltung-bundle/.ecs/config/legacy.php
:: templates
vendor\bin\ecs check vendor/markocupic/rsz-benutzerverwaltung-bundle/src/Resources/contao/templates --config vendor/markocupic/rsz-benutzerverwaltung-bundle/.ecs/config/template.php
::
