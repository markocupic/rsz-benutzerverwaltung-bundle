...
\Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ...
    ->addField(['mcupic_be_benutzerverwaltung_funktion', 'mcupic_be_benutzerverwaltung_niveau', 'mcupic_be_benutzerverwaltung_trainingsgruppe', 'mcupic_be_benutzerverwaltung_trainerqualifikation'], 'rsz_benutzerverwaltung')
