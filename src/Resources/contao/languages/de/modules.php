...
$GLOBALS['TL_LANG']['MOD']['mcupic_be_benutzerverwaltung'] = array('RSZ Benutzerverwaltung', 'Benutzerangaben verwalten');
$objUser = \BackendUser::getInstance();
if (!$objUser->isAdmin && !$objUser->isMemberOf($GLOBALS['TL_CONFIG']['mcupic_be_benutzerverwaltung_id_group_address_admin']) )
{
	$GLOBALS['TL_LANG']['MOD']['mcupic_be_benutzerverwaltung'] = array('Mein Konto', 'Meine Benutzerangaben verwalten');
}
